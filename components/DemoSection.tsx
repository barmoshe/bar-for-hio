      ...
      <div className="mx-auto max-w-5xl">
        <div className="mx-auto mb-10 max-w-2xl text-center">
          ...
          <p className="mt-4 leading-relaxed text-body">
            hio&apos;s loop, rebuilt client-side. Messages land from every channel,
            the urgent ones rise to the top, and a reply is drafted in the
            owner&apos;s voice. Pick any message, then approve or edit it.
          </p>
        </div>
        ...
        <p className="mx-auto mt-6 max-w-2xl text-center text-[13px] text-muted">
          Built for this application in an afternoon. The real thing needs a model
          behind the draft and a Node service behind the channels. The front-end
          craft is the same.
        </p>
      </div>
    </section>
